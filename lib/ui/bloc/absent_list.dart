...
class AbsentListBloc extends BaseBloc<Result<List<HolidayData>>> {
  ApiRepo repository;

  AbsentListBloc(this.repository);
  ...
  Future<void> get() async {
    ...
    try {
      ...
      if (map.containsKey("result")) {
        List<HolidayData> dataList = (map["result"]["items"] as List)
      ...
      appLog("Error AbsentListBloc: ${e.toString()}");
      emit(Result.error('codeBadRequest'));
    }
  }
}
